...
<div class="site-branding-alternative">
    <?php 
    $sticky_logo_url = get_theme_mod( 'secondary_branding' );
    $sticky_logo_alt = get_theme_mod( 'secondary_branding_alt_text' );
    if ($sticky_logo_url )
       echo '<img src="'.$sticky_logo_url.'" alt = "'.$sticky_logo_alt.'" class="sticky_logo_class">';
    ?>
</div>